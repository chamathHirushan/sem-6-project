          ...
          <div className="flex justify-between">
            <div>
              ...
              <div className="flex items-center my-1">
                ...
                <p className="text-gray-600 text-sm"><span className="font-bold">Task posted: </span>{job.daysPosted} ago</p>
              </div>
            </div>
          ...
          <div>
            <div className="flex flex-col gap-0.5">
              ...
              <div className="flex items-center justify-center my-2">
                <p className="text-black text-2xl font-bold">Rs. {job.budget}</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-600 text-sm">Due Date: {job.dueDate}</p>
              </div>

              {/* Posted Date */ }
              <div className="flex items-center">
                <CalendarDaysIcon className="w-4 h-4 mr-1" style={{ color: "green" }}/>
                <p className="text-gray-600 text-sm">Posted Date: {job.postedDate}</p>
              </div>        
            ...
            {/* Mini Description */ } 
            <p className="text-gray-600 mb-4 text-sm">{job.miniDescription}</p>
